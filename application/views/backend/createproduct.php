<div id="page-title">
<a href="<?php echo site_url("site/viewproduct"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
...
<div class="col-sm-4">
<input type="text" id="normal-field" class="form-control" name="xsize" value='<?php echo set_value('xsize');?>'>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label" for="normal-field">Y-Size</label>
<div class="col-sm-4">
<input type="text" id="normal-field" class="form-control" name="ysize" value='<?php echo set_value('ysize');?>'>
</div>
</div>
<div class=" form-group">
